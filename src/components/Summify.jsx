  ...
  return (
    <div className="p-[2.5rem]">
      <div className="text-center">
        ...
        <textarea
          className="border-[3px] border-blue-300 w-[100%] h-[200px] rounded-2xl p-[1em] 
          placeholder:text-gray-500 placeholder:font-medium text-black 
        ...
        <button
          className="bg-blue-400 text-black font-bold px-5 py-2 rounded-lg hover:bg-blue-300 transition"
      ...
      {summarizedData && (
        <div className="mt-6 p-4 border-3 border-blue-500 rounded-lg bg-blue-100">
          <div className="flex justify-between">
          <h3 className="text-2xl font-bold text-blue-800">Summary:</h3>
          <div>
            <button className="btn bg-blue-400 text-black font-bold px-5 py-2 rounded-lg hover:bg-blue-300 transition " onClick={() => setSummarizedData("")}>
                Clear
            </button>
          </div>
          </div>
          <p className="text-black font-semibold whitespace-pre-line">{summarizedData}</p>
        </div>
      )}
    </div>
  );
